...
class PanelFrame {
    public PanelFrame() {
        ...
        secondPanel.setPreferredSize(new Dimension(160, 300));
        ...
        thirdPanel.setPreferredSize(new Dimension(300, 300));
        thirdPanel.setBackground(Color.orange);
        // ImageIcon을 사용하여 이미지를 불러옵니다. [cite: 248, 270]
        ...
        // 3. 메인 패널에 모든 컴포넌트 추가
        // 메인 패널은 다른 패널들을 담는 컨테이너 역할을 합니다.
        ...
        frame.pack(); // 컴포넌트 크기에 맞게 프레임 크기 조절 [cite: 164]
        frame.setVisible(true); // 프레임을 화면에 보이게 함 [cite: 165]
    }
}

public class ClassExercises_Image_Q3 {
